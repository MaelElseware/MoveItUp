...
namespace TriviaExercise
{
    public partial class MainWindow : Window
    {
        ...
        private void SetDefaultDataFolder()
        {
            ...
            CreateSampleJsonFilesIfNotExist();
        }
        ...
        private void CreateSampleJsonFilesIfNotExist()
        {
            string baseDirectory = DataFolderPathTextBox.Text;
            string questionsPath = Path.Combine(baseDirectory, "Questions_GeneralCulture.json");
            string exercisesPath = Path.Combine(baseDirectory, "exercises.json");
            ...
            if (!File.Exists(questionsPath))
            {
                ...
                try
                {
                    ...
                    StatusTextBox.Text += $"Created sample questions file at: {questionsPath}\n";
                }
                catch (Exception ex)
                {
                    StatusTextBox.Text += $"Error creating questions file: {ex.Message}\n";
                }
            }
            ...
            if (!File.Exists(exercisesPath))
            {
                ...
                try
                {
                    ...
                    StatusTextBox.Text += $"Created sample exercises file at: {exercisesPath}\n";
                }
                catch (Exception ex)
                {
                    StatusTextBox.Text += $"Error creating exercises file: {ex.Message}\n";
                }
            }
        }
